...
\tikzset{square right brace/.style={ncbar=-0.15cm}}
  ...
  \node (root) {\AI{Add}}
  child {node (node1) {\AI{Add}} child {node [label=below:\pgftextcircled{5}] (node2) {\AI{Val}\AS{}\AN{3}}} 
                                 child {node (node3) {\AI{Add}} 
                                   child {node [label=below:\pgftextcircled{4}] (node4) {\AI{Val}\AS{}\AN{7}}}
                                   child {node [label=below right:\pgftextcircled{3}] (node5) {\AI{Val}\AS{}\AN{1}}}}} 
  child {node (node6) {\AI{Add}} child {node [label=below:\pgftextcircled{2}] (node7) {\AI{Val}\AS{}\AN{2}}}
                                 child {node [label=below right:\pgftextcircled{1}] (node8) {\AI{Val}\AS{}\AN{0}}}};
  ...
  \draw [thick] (3.5,-5) to [square right brace ] (3.5,-4);
	\node at (-0.75,-4.5) (right1) {{\color{red}\AI{Right}}\AS{}\AN{7},};
	\node at (0.6,-4.5)    (right2) {{\color{blue}\AI{Right}}\AS{}\AN{3},};
  \node at  (1.75,-4.5) {\color{blue}\AI{Left}};
