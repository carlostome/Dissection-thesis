...
\frame{
  ...
  \begin{center}
    \only<1-3>{\large \ensuremath{\AF{unload\ensuremath{^{+}}}\;\mathbin{:}\;(\AD{\ensuremath{\mathbb{N}}}\;\AF{\ensuremath{\times}}\;\AD{Stack})\;\to \;(\AD{\ensuremath{\mathbb{N}}}\;\AF{\ensuremath{\times}}\;\AD{Stack})\;\AD{\ensuremath{\uplus}}\;\AD{\ensuremath{\mathbb{N}}}}}
    \only<4>{\large \ensuremath{\AF{unload\ensuremath{^{+}}}\;\mathbin{:}\;\AD{Config}\;\to \;\AD{Config}\;\AD{\ensuremath{\uplus}}\;\AD{\ensuremath{\mathbb{N}}}}}
  \end{center}
  \pause
  \begin{itemize}[<+->]
    \setlength\itemsep{1em}
...
\frame{
  \frametitle{Well-founded recursion}
    ...
    \setlength\itemsep{1.25em}
      \item Function \ensuremath{\Varid{f}\;\mathbin{:}\;\AB{\ensuremath{\alpha}}\;\to \;\AB{\ensuremath{\alpha}}} \textbf{not} defined by structural recursion.
